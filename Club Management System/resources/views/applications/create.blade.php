        ...
        <div class="p-5 w-75 mx-auto shadow p-3 bg-white rounded">
            ...
            <form method="POST" action="{{ route('applications.store') }}">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="application_title" name="application_title"
                ...
                <div class="form-group">
                    <input type="date" class="form-control" id="application_date" name="application_date"
                        placeholder="Application Date" required>
                </div>

                <!-- Application Description -->
                <div class="form-group">
                    <textarea class="form-control" id="application_description" name="application_description"
                        placeholder="Application Description" required></textarea>
                </div>
                ...
                <div class="form-group shadow p-3 m-5 bg-white rounded">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="checkbox" id="adminisrtration" name="departments[]" value="Administration">
                            <label for="adminisrtration">Administration</label><br>
