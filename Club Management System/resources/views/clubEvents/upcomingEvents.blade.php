...
<body>
 ...
 <div class="site-wrap">
   ...
   @include('menu.navBar')
    ...
    <h4 class="text-center p-5">Upcoming Events</h4>
  
    <div class= "m-2">
    <a href="event-page" class="card text-white bg-info m-auto" style="max-width: 80%;">
        ...
        <div class="p-2 pt-5 border-right border-2" style="width: 30%"><h3 class=text-center>5<h3><p class=text-center>Jan</p></div>
          <div class="p-2" style="width: 60%"><h3 class="">Event Name</h3>
            <p class=" text-truncate">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
            <p class="mt-5">10:00AM-5:00PM</p></div>
