...
<head>
    ...
    <link rel="stylesheet" href="css/home2test.css">
...
<body>
    ...
    <div class="site-wrap pb-3">
        ...
        <div class=" card-section site-section d-flex justify-content-between flex-wrap p-3">
            ...
            <a href="{{ route('loadContent', ['contentType' => 'Workshops']) }}" class="card text-white bg-info m-2" style="width: 10rem; height:10rem; border-radius: 20px;">
                <i class="bi bi-book card-icon-size text-center mb-2"></i>
                <h6 class="card-title text-center">WorkShops</h6>
            </a>
    

            <a href="{{ route('loadContent', ['contentType' => 'Club Recruitments']) }}" class="card text-white bg-info m-2" style="width: 10rem; height:10rem; border-radius: 20px;">
            ...
            <a href="{{ route('loadContent', ['contentType' => 'Upcoming Events']) }}" class="card text-white bg-info m-2" style="width: 10rem; height:10rem; border-radius: 20px;">
        ...
        <div class="admin-panel shadow-lg p-4 mt-4 mb-3">
            ...
            <a href="/superAdmin/manage-clubs" class="card text-white bg-info m-3 p-3">
            ...
            <a href="/applications/create" class="card text-white bg-info m-3 p-3">
                <div class="card-body d-flex justify-content-between">
                    <h5 class="card-title">Create Application for a Club</h5><i class="bi bi-caret-right-fill"></i>
                </div>
            </a>

            <a href="/myClubs/manage-posts/create-post" class="card text-white bg-info m-3 p-3">
                <div class="card-body d-flex justify-content-between">
                    <h5 class="card-title">Create New Post for a Club</h5><i class="bi bi-caret-right-fill"></i>
                </div>
            </a>

            <a href="/myClubs/manage-posts" class="card text-white bg-info m-3 p-3">
        ...
        <div class=" card-section site-section d-flex justify-content-between flex-wrap p-3">
            ...
            <a href="my-clubs" class="card text-white bg-info m-2" style="width: 10rem; height:10rem; border-radius: 20px;">
