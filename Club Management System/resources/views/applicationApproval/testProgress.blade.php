    ...
    <h4 class="text-center">Other Departments</h4>
      ...
      <div style="margin-left:10px">
        ...
        <ul class="StepProgress2">
            ...
            <div class="StepProgress-item current">
                <strong>CITS</strong></div>
            <div class="StepProgress-item current">
                <strong>Finance</strong></div>
            <div class="StepProgress-item current">
                <strong>Administration</strong></div>
            <div class="StepProgress-item current">
                <strong>Council Affairs</strong></div>
        </ul>
        </div>
        ...
        <div class="wrapper3">
            <fieldset id="c-group">
                <label for="c1">
                    <input type="checkbox" id="c1" name="c-group" disabled>
                        <span class="label-text">ONM</span>
                </label>
                <label for="c2">
                    <input type="checkbox" id="c2" name="c-group" disabled>
                        <span class="label-text">Facilities</span>
                </label>
                <label for="c3">
                    <input type="checkbox" id="c3" name="c-group" disabled>
                        <span class="label-text">Security</span>
                </label>
                <label for="c4">
                    <input type="checkbox" id="c4" name="c-group" disabled>
                        <span class="label-text">MPR</span>
                </label>
                <label for="c5">
                    <input type="checkbox" id="c5" name="c-group" disabled>
                ...
                <label for="c7">
                    <input type="checkbox" id="c5" name="c-group" disabled>
                        <span class="label-text">Administration</span>
                </label>
                <label for="c8">
                    <input type="checkbox" id="c5" name="c-group" disabled>
                        <span class="label-text">Council Affairs</span>
                </label>
            </fieldset>
      </div>
